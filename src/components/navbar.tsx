      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="flex items-center gap-3 border-l border-neutral-800 pl-6">
            ...
            <a href="https://medium.com/@aditya41150" target="_blank" rel="noopener noreferrer"><BookOpen className="w-5 h-5 text-neutral-400 hover:text-white transition" /></a>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex flex-col gap-8 text-2xl text-white">
                ...
                <div className="flex gap-8 mt-10 border-t border-neutral-800 pt-8">
                  ...
                  <a href="https://medium.com/@aditya41150" target="_blank" rel="noopener noreferrer">
